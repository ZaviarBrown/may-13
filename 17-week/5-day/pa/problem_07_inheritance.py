...
class FlyingDragon(Dragon):
    ...
    def encounter(self):
        return f"While traveling you suddenly meet a flying dragon named {self._name}! {f'It lets you take a selfie and admire its {self._color} scales.' if self._is_good else super().breathes_fire()}"
        # return f"While traveling you suddenly meet a flying dragon named {self._name}! {f'It lets you take a selfie and admire its {self._color} scales.' if self._is_good else self.breathes_fire()}"
