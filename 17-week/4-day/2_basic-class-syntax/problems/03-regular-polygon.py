...
#    variable for this instance to the identified type based on the logic below
...
class RegularPolygon:
    ...
    #! Potentially dangerous...but that's my middle name 😎
    poly_types = {
        3: "Triangle",
        4: "Quadrilateral",
        5: "Pentagon",
    ...
    def identify_polygon(self):
        ...
        self.type = self.poly_types[self.num_sides]
    ...
    def get_perimeter(poly):
        return poly.num_sides * poly.length
...
print(
    f"{dodecagon.num_sides} sides of length {dodecagon.length}"
...
print(
    RegularPolygon.polygon_factory([(5, 5), (3, 2), (8, 10)])
