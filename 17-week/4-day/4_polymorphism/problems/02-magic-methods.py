...
class StrNumeric:
    def __init__(self, value) -> None:
        if isinstance(value, str) and value.isnumeric():
            ...
            raise Exception("Gotta be whole numbers only bruh")

    def __add__(self, thing_2) -> int:
        if isinstance(thing_2, str):
            return "Stoopppp iittttt"
        else:
            print(thing_2, "Hey look at me")
            return int(self.val) + int(thing_2)

    def __sub__(self, thing_2):
        return "hey"
...
print(str_44 + 6)  # 50
print(str_44 + "Heyyyyyy")  # STOP
print(str_44 - "whatever")
